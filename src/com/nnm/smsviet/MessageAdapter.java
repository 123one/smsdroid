...
public class MessageAdapter extends ResourceCursorAdapter {
	...
	public final void bindView(final View view, final Context context,
		...
		case Message.MMS_OUT:
			...
			try {
				holder.vLayout
						.setBackgroundResource(this.backgroundDrawableOut);
				// holder.vLayout.setBackgroundResource(R.drawable.conv_sent_bubble);
		...
		default:
			...
			try {
				...
				// holder.vLayout.setBackgroundResource(R.drawable.conv_receive_bubble_focused);
			} catch (OutOfMemoryError e) {
				Log.e(TAG, "OOM while setting bg", e);
			}
			holder.ivInOut
		...
		if (pic != null) {
			...
			holder.ivPhoto.setOnClickListener(SMSdroid.getOnClickStartActivity(
					context, i));
			holder.ivPhoto.setOnLongClickListener(m
