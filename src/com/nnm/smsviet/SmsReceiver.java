...
public class SmsReceiver extends BroadcastReceiver {
	...
	static final int updateNewMessageNotification(final Context context,
		...
		if (l == 0) {
			...
			NotificationCompat2.Builder nb = new NotificationCompat2.Builder(
					context);
			...
			if (tid >= 0) {
				...
				if (enableNotifications) {
					...
					if (conv != null) {
						...
						if (l == 1) {
							...
							nb.setContentTitle(a);
							nb.setContentText(context.getString(
									R.string.new_messages, l));
							nb.setContentIntent(pIntent);
						}
				...
				if (enableNotifications) {
					...
					nb.setWhen(lastUnreadDate);
					nb.setContentTitle(context
							.getString(R.string.new_messages_));
					nb.setContentText(context.getString(R.string.new_messages,
							l));
					nb.setContentIntent(pIntent);
					nb.setNumber(l);
				}
