 ...
 * @author flx
 */
public class MessageListActivity extends SherlockActivity implements
		OnItemClickListener, OnItemLongClickListener, OnClickListener,
		OnLongClickListener, Cons {
	/** Tag for output. */
	...
	private void parseIntent(final Intent intent) {
		...
		if (this.uri != null) {
			...
			if (tid < 0L) {
				try {
					this.startActivity(ConversationListActivity
							.getComposeIntent(this, null));
		...
		this.getLastPathSegment = Integer.parseInt(this.uri
				.getLastPathSegment());
		...
		this.buaQuickAction
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(final QuickAction source,
						...
						final String sms = MessageListActivity.this.etText
								.getText().toString();
						String smstemp = sms;

						switch (actionId) {
						case 0:// lai tu
							MessageListActivity.this.etText.setText(HandleSms
									.reserverSmS(sms));
							break;
						case 1: // dao tung chu
							MessageListActivity.this.etText.setText(HandleSms
						...
						case 3: // tu bo dau
							if (!Utlis
									.checkNetworkStatus(MessageListActivity.this)) {
								Toast.makeText(
								...
								Runnable aRun = new Runnable() {
									...
									public void run() {
										...
										msg.what = BO_DAU_SMS;
										MessageListActivity.this.mHandler
												.sendMessage(msg);
									}
								};
						...
						case 4: // viet nguoc
							if (Utlis.getAPILevel() < 14) {
								...
								MessageListActivity.this.etText.setText(Utlis
										.flipString(smstemp));
							}
							break;
						case 5: // rusify
						...
						case 6: // text emoticons
							...
							break;
						case 7: // binh thuong
							MessageListActivity.this.etText
									.setText(MessageListActivity.this.originalSmS);
							break;
	...
	public void initDialog() {
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(final AdapterView<?> arg0, final View arg1,
				...
				if (MessageListActivity.this.etText.getText().toString()
						.endsWith(" ")) {
			...
			public void onClick(final DialogInterface dialog, final int which) {
				...
				case WHICH_VIEW_DETAILS:
					...
					final String ds = DateFormat.format(
							context.getString(R.string.DATEFORMAT_details), d)
							.toString();
					String sentReceived;
					String fromTo;
	...
	private Intent buildIntent(final boolean autosend, final boolean showChooser) {
		...
		final Intent i = this.getComposeIntent(this, this.conv.getContact()
				.getNumber());
